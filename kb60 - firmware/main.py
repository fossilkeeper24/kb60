...
keyboard.keymap = [
    [ #LAYER 0: BASE
        KC.ESC, KC.N1,    KC.N2,    KC.N3,    KC.N4,    KC.N5,    KC.N6,    KC.N7,    KC.N8,    KC.N9,    KC.N0,    KC.MINS, KC.EQL,  KC.BSPC, KC.MUTE, 
        ...
        KC.LCTL, KC.LGUI, KC.LALT, KC.NO,   KC.NO,   KC.NO,   KC.SPC,   KC.NO,  KC.NO,   KC.NO,   KC.RALT, RAISE,   KC.LEFT, KC.DOWN, KC.RGHT,
        ],
        [ #LAYER 1: FN
        KC.ESC, KC.F1,   KC.F2,   KC.F3,   KC.F4,   KC.F5,   KC.F6,   KC.F7,   KC.F8,   KC.F9,   KC.F10,  KC.F11,  KC.F12,    KC.DELETE, KC.GRV,
        ...
        TRANS,   TRANS,   TRANS,   KC.NO,   KC.NO,   KC.NO,   TRANS,   KC.NO,   KC.NO,   KC.NO,   TRANS,   TRANS,   KC.HOME,   KC.PGDN,   KC.END,
        ]
]
